...
from SLRtable import generate_parser_tables


combined_table,errorList,production_list,action_table, goto_table = generate_parser_tables(states, transitions, converted_prod, follow,Terminals,nonTerminals)
...
def parseoToken(file_name,production_list, action_table, goto_table ):
    error_stack = []
...
parseoToken(file_path,production_list, action_table, goto_table)
